...
def process_files(folder_path, output_excel_file):
    """
    Process all text files in a specified folder, extract data using the process_single_file method, 
    ...
    # Apply text replacements using stupid_horse_names
    ...
    # If data has been successfully extracted, write it to an Excel file
    if all_data:
        ...
        # Write the DataFrame to an Excel file with the first row frozen for readability
