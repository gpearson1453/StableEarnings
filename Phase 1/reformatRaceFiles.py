...
def reformat_files_sequentially(originals_folder, text_folder_base):
    ...
    1. Iterates over each subfolder in the originals folder.
    ...
    Parameters:
    - originals_folder (str): Path to the folder containing the original subfolders with PDF files.
    ...
    # Iterate over each subfolder in the originals directory
...
# Call the function with the 'originals' and 'text_files' directories
