...
def dropAltTrainables():
    """
    Drop the 'AltTrainables' table if it exists.

    Returns:
        str: A SQL query string to drop the 'AltTrainables' table, including all dependent objects.
    """
    return "DROP TABLE IF EXISTS AltTrainables CASCADE;"
...
def createAltTrainables():
    """
    Create the 'AltTrainables' table in the database.

    Returns:
        str: A SQL query string to create the 'AltTrainables' table with its schema definition.
    """
    return """
        CREATE TABLE IF NOT EXISTS AltTrainables (
            race_id VARCHAR(255),
            final_pos INT,
            horse_n_name VARCHAR(255),
            race_type VARCHAR(255),
...
def addAltTrainable(
    ...
    """
    Add a new alternate trainable record to the 'AltTrainables' table.
